!(function (i) {
    ...
    function n(t, e) {
        (this.settings = e),
            ...
            (this.spinner = {
                phase: 0,
                timeSlot: 150,
                $el: d('<div class="spinner"><span></span><span></span><span></span></div>'),
                intervalId: null,
            }),
            (this.scrollBarOn = !1),
    ...
    (n.prototype.getSuffix = function (t, e) {
        ...
        (n.prototype.newSrc = function (t, e, i, s) {
            ...
            return (
                this.settings.thumbnailPath
                    ? (r = this.settings.thumbnailPath(t, e, i, s))
                    : ((n = null !== (o = t.match(this.settings.extension)) ? o[0] : ""),
                      (r = t.replace(this.settings.extension, "")),
                      (r = this.removeSuffix(r, this.getUsedSuffix(r))),
                      (r += this.getSuffix(e, i) + n)),
                r
            );
        }),
        ...
        (n.prototype.displayEntry = function (t, e, i, s, o, n) {
            ...
            null !== h
                ? (h.css("width", s),
                  ...
                  h.css("margin-top", -o / 2),
                  (r = h.attr("src")),
                  (l = this.newSrc(r, s, o, h[0])),
                  ...
                  "skipped" === t.data("jg.loaded")
                      ? this.onImageEvent(
                            r,
                            d.proxy(function () {
                                this.showImg(t, a), t.data("jg.loaded", !0);
                            }, this)
                        )
                      : this.showImg(t, a))
                : this.showImg(t),
        ...
        (n.prototype.prepareBuildingRow = function (t) {
            ...
            for (
                ...
                (s = (i = this.buildingRow.entriesBuff[e]).data("jg.width") / i.data("jg.height")),
                    (n = r ? ((o = e === this.buildingRow.entriesBuff.length - 1 ? a : h * s), h) : ((o = d * s), d)),
                    (a -= Math.round(o)),
                    i.data("jg.jwidth", Math.round(o)),
                    i.data("jg.jheight", Math.ceil(n)),
                    (0 === e || n < l) && (l = n);
        ...
        (n.prototype.flushRow = function (t) {
            var e,
                i = this.settings,
                s = this.border,
                o = this.prepareBuildingRow(t);
            if (t && "hide" === i.lastRow && -1 === o) this.clearBuildingRow();
            else {
                if (
                    (this.maxRowHeight &&
                    ...
                    for (
                        ...
                        n -= (e = this.buildingRow.entriesBuff[r]).data("jg.jwidth");
                    "center" === i.lastRow ? (s += n / 2) : "right" === i.lastRow && (s += n);
                }
                var l = this.buildingRow.entriesBuff.length - 1;
                for (r = 0; r <= l; r++)
                    (e = this.buildingRow.entriesBuff[this.settings.rtl ? l - r : r]),
                        this.displayEntry(
                            e,
                            s,
                            this.offY,
                        ...
                        (s += e.data("jg.jwidth") + i.margins);
                (this.galleryHeightToSet = this.offY + this.buildingRow.height + this.border),
                    this.setGalleryTempHeight(this.galleryHeightToSet + this.getSpinnerHeight()),
                    (!t || (this.buildingRow.height <= i.rowHeight && o)) &&
    ...
    var e = 0;
    function i() {
        return d("body").height() > d(window).height();
    }
    (n.prototype.rememberGalleryHeight = function () {
                ...
                d.proxy(function () {
                    ...
                    this.$gallery.is(":visible") &&
                        ...
                        i() === this.scrollBarOn
                            ...
                            : ((this.scrollBarOn = i()), (this.galleryWidth = t)));
                }, this),
        ...
        (n.prototype.updateEntries = function (t) {
            var e =
                t && null != this.lastFetchedEntry
                    ? d(this.lastFetchedEntry).nextAll(this.settings.selector).toArray()
                    : ((this.entries = []), this.$gallery.children(this.settings.selector).toArray());
            return (
                0 < e.length &&
        ...
        (n.prototype.shuffleArray = function (t) {
            for (var e, i, s = t.length - 1; 0 < s; s--)
                (e = Math.floor(Math.random() * (s + 1))), (i = t[s]), (t[s] = t[e]), (t[e] = i);
                ...
                d.each(
                    ...
                    d.proxy(function (t, e) {
                        ...
                        i.data("jg.createdCaption")
                            ? (i.data("jg.createdCaption", void 0), null !== o && o.remove())
                            : null !== o && o.fadeTo(0, 1);
                    }, this)
                ),
        ...
        (n.prototype.analyzeImages = function (t) {
            for (var e = this.lastAnalyzedIndex + 1; e < this.entries.length; e++) {
                ...
                if (!0 === i.data("jg.loaded") || "skipped" === i.data("jg.loaded")) {
                    ...
                    if (
                        s / (this.buildingRow.aspectRatio + o) < this.settings.rowHeight &&
                    ...
                    this.buildingRow.entriesBuff.push(i),
                        (this.buildingRow.aspectRatio += o),
                        (this.buildingRow.width += o * this.settings.rowHeight),
            ...
            d.each(this.entries, function (t, e) {
                ...
                if ((i.addClass("jg-entry"), !0 !== i.data("jg.loaded") && "skipped" !== i.data("jg.loaded")))
                    if (
                        ...
                        var o = h.extractImgSrcFromImage(s);
                        if ((s.attr("src", o), !1 === h.settings.waitThumbnailsLoad)) {
                            var n = parseFloat(s.prop("width")),
                                r = parseFloat(s.prop("height"));
                            if (!isNaN(n) && !isNaN(r))
                                return (
                                    i.data("jg.width", n),
                                    i.data("jg.height", r),
                ...
                l || a || this.startImgAnalyzer(!1),
                this.checkWidth();
        }),
        (n.prototype.checkOrConvertNumber = function (t, e) {
            if (("string" === d.type(t[e]) && (t[e] = parseFloat(t[e])), "number" !== d.type(t[e])))
        ...
        (d.fn.justifiedGallery = function (o) {
            return this.each(function (t, e) {
                var i = d(e);
                i.addClass("justified-gallery");
                var s = i.data("jg.controller");
                if (void 0 === s) {
                    if (null != o && "object" !== d.type(o)) {
                        if ("destroy" === o) return;
                        throw "The argument must be an object";
                    }
                    (s = new n(i, d.extend({}, n.prototype.defaults, o))), i.data("jg.controller", s);
                } else if ("norewind" !== o) {
    ...
    (function (t) {
        ...
        if (g.event.fixHooks) for (var i = t.length; i; ) g.event.fixHooks[t[--i]] = g.event.mouseHooks;
        var p = (g.event.special.mousewheel = {
            version: "3.1.12",
            setup: function () {
                if (this.addEventListener) for (var t = e.length; t; ) this.addEventListener(e[--t], s, !1);
                else this.onmousewheel = s;
                g.data(this, "mousewheel-line-height", p.getLineHeight(this)),
                    g.data(this, "mousewheel-page-height", p.getPageHeight(this));
            },
            teardown: function () {
                if (this.removeEventListener) for (var t = e.length; t; ) this.removeEventListener(e[--t], s, !1);
                else this.onmousewheel = null;
                g.removeData(this, "mousewheel-line-height"), g.removeData(this, "mousewheel-page-height");
            },
            getLineHeight: function (t) {
                var e = g(t),
                    i = e["offsetParent" in g.fn ? "offsetParent" : "parent"]();
                return (
                    i.length || (i = g("body")),
        ...
        function s(t) {
            var e,
                ...
                u = 0;
            if (
                (((t = g.event.fix(n)).type = "mousewheel"),
                "detail" in n && (h = -1 * n.detail),
                "wheelDelta" in n && (h = n.wheelDelta),
                "wheelDeltaY" in n && (h = n.wheelDeltaY),
                "wheelDeltaX" in n && (a = -1 * n.wheelDeltaX),
                "axis" in n && n.axis === n.HORIZONTAL_AXIS && ((a = -1 * h), (h = 0)),
                (l = 0 === h ? a : h),
                "deltaY" in n && (l = h = -1 * n.deltaY),
                "deltaX" in n && ((a = n.deltaX), 0 === h && (l = -1 * a)),
                0 !== h || 0 !== a)
            )
                return (
                    1 === n.deltaMode
                        ? ((l *= i = g.data(this, "mousewheel-line-height")), (h *= i), (a *= i))
                        : 2 === n.deltaMode && ((l *= s = g.data(this, "mousewheel-page-height")), (h *= s), (a *= s)),
                    (e = Math.max(Math.abs(h), Math.abs(a))),
                    (!m || e < m) && b(n, (m = e)) && (m /= 40),
                    b(n, e) && ((l /= 40), (a /= 40), (h /= 40)),
                    (l = Math[1 <= l ? "floor" : "ceil"](l / m)),
                    (a = Math[1 <= a ? "floor" : "ceil"](a / m)),
                    (h = Math[1 <= h ? "floor" : "ceil"](h / m)),
                    p.settings.normalizeOffset &&
                        this.getBoundingClientRect &&
                        ((o = this.getBoundingClientRect()), (d = t.clientX - o.left), (u = t.clientY - o.top)),
                    (t.deltaX = a),
                    (t.deltaY = h),
                    (t.deltaFactor = m),
                    (t.offsetX = d),
                    ...
                    c && clearTimeout(c),
                    (c = setTimeout(y, 200)),
                    (g.event.dispatch || g.event.handle).apply(this, r)
                );
        }
        function y() {
            m = null;
    ...
    (function () {
        ...
        (e.prototype.init = function () {
                ...
                t.s.dynamic
                    ...
                    : t.$items.on("click.lgcustom", function (e) {
                          ...
                          t.$el.trigger("onBeforeOpen.lg"),
                              ...
                              $("body").hasClass("lg-on") || (t.build(t.index), $("body").addClass("lg-on"));
                      });
        }),
            ...
            (e.prototype.structure = function () {
                ...
                this.s.controls &&
                    ...
                    ".lg-sub-html" === this.s.appendSubHtmlTo &&
                        (s = '<div role="status" aria-live="polite" class="lg-sub-html"></div>');
                var n,
                    r =
                        ...
                        '"><div class="lg-inner">' +
                         t +
                        '</div><div class="lg-toolbar lg-group"><button aria-label="Close gallery" class="lg-close lg-icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button></div>' +
                        e +
                        s +
                        "</div></div>";
                $("body").append(r),
                    ...
                    this.s.download &&
                        this.$outer
                            .find(".lg-toolbar")
                            .append(
                                '<a id="lg-download" aria-label="Download" target="_blank" download class="lg-download lg-icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg></a>'
                            ),
            ...
            (e.prototype.setTop = function () {
                var t, e, i;
                "100%" !== this.s.height &&
                    ((e = ((t = $(window).height()) - parseInt(this.s.height, 10)) / 2),
            ...
            (e.prototype.isVideo = function (t, e) {
                ...
                return s ? { youtube: s } : o ? { vimeo: o } : n ? { dailymotion: n } : r ? { vk: r } : void 0;
            }),
            ...
            (e.prototype.addHtml = function (t) {
                ...
                this.s.dynamic
                    ...
                    e ||
                        (null != o
                            ? ("." !== (s = o.substring(0, 1)) && "#" !== s) ||
                              (o = this.s.subHtmlSelectorRelative && !this.s.dynamic ? i.find(o).html() : $(o).html())
                            : (o = "")),
                    ".lg-sub-html" === this.s.appendSubHtmlTo
                        ? e
            ...
            (e.prototype.loadContent = function (e, t, i) {
                function s(t) {
                    ...
                    for (var n = $(window).width(), r = 0; r < e.length; r++)
                ...
                var o,
                    ...
                    g = !1,
                    c = u.s.dynamic
                        ? (u.s.dynamicEl[e].poster && ((g = !0), (n = u.s.dynamicEl[e].poster)),
                          (a = u.s.dynamicEl[e].html),
                          (l = u.s.dynamicEl[e].src),
                          (h = u.s.dynamicEl[e].alt),
                          u.s.dynamicEl[e].responsive && s(u.s.dynamicEl[e].responsive.split(",")),
                          (r = u.s.dynamicEl[e].srcset),
                          u.s.dynamicEl[e].sizes)
                        : ((d = u.$items.eq(e)).attr("data-poster") && ((g = !0), (n = d.attr("data-poster"))),
                          (a = d.attr("data-html")),
                          (l = d.attr("href") || d.attr("data-src")),
                          (h = d.attr("title") || d.find("img").first().attr("alt")),
                          d.attr("data-responsive") && s(d.attr("data-responsive").split(",")),
                          (r = d.attr("data-srcset")),
                          d.attr("data-sizes")),
                    m = !1;
                u.s.dynamic
                    ? u.s.dynamicEl[e].iframe && (m = !0)
                    : "true" === u.$items.eq(e).attr("data-iframe") && (m = !0);
                var f,
                    p = u.isVideo(l, e);
                    ...
                    if (
                        (m
                            ...
                            : g
                              ? ((f = ""),
                                (f =
                                    p && p.youtube ? "lg-has-youtube" : p && p.vimeo ? "lg-has-vimeo" : "lg-has-html5"),
                                u.$slide
                                    .eq(e)
                                    .prepend(
                              ...
                              : p
                                ? (u.$slide
                                  ...
                                  u.$el.trigger("hasVideo.lg", [e, l, a]))
                                : ((h = h ? 'alt="' + h + '"' : ""),
                                  u.$slide
                                      .eq(e)
                                      .prepend(
                ...
                u.$slide
                    ...
                    p && p.html5 && !g && u.$slide.eq(e).addClass("lg-complete"),
                    !0 === t &&
                    ...
                    d.lgBusy ||
                        (this.s.download &&
                            ((r = d.s.dynamic
                                ...
                                ? ($("#lg-download").attr("href", r), d.$outer.removeClass("lg-hide-download"))
                        ...
                        e
                            ? (this.$slide.removeClass("lg-prev-slide lg-current lg-next-slide"),
                              2 < o
                                  ? ((l = t - 1),
                                    (a = t + 1),
                                    ((0 === t && h === o - 1) || (t === o - 1 && 0 === h)) && ((a = 0), (l = o - 1)))
                                  : ((l = 0), (a = 1)),
                              "prev" === s
                                  ? d.$slide.eq(a).addClass("lg-next-slide")
                                  : d.$slide.eq(l).addClass("lg-prev-slide"),
                              d.$slide.eq(t).addClass("lg-current"))
                            : (d.$outer.addClass("lg-no-trans"),
                              this.$slide.removeClass("lg-prev-slide lg-next-slide"),
                              "prev" === s
                                  ? (this.$slide.eq(t).addClass("lg-prev-slide"),
                                    this.$slide.eq(h).addClass("lg-next-slide"))
            ...
            (e.prototype.keyPress = function () {
                var e = this;
                1 < this.$items.length &&
                    $(window).on("keyup.lg", function (t) {
                        1 < e.$items.length &&
                            (37 === t.keyCode && (t.preventDefault(), e.goToPrevSlide()),
                            39 === t.keyCode && (t.preventDefault(), e.goToNextSlide()));
                    }),
                    $(window).on("keydown.lg", function (t) {
                        !0 === e.s.escKey &&
                            27 === t.keyCode &&
                            (t.preventDefault(),
                ...
                e.s.enableSwipe &&
                    ...
                    (e.$slide.on("touchstart.lg", function (t) {
                        e.$outer.hasClass("lg-zoomed") ||
                            e.lgBusy ||
                            (t.preventDefault(), e.manageSwipeClass(), (i = t.originalEvent.targetTouches[0].pageX));
                    }),
                    ...
                    e.$slide.on("touchend.lg", function () {
                        e.$outer.hasClass("lg-zoomed") ||
                            (o ? ((o = !1), e.touchEnd(s - i)) : e.$el.trigger("onSlideClick.lg"));
                    }));
            }),
            (e.prototype.enableDrag = function () {
                ...
                e.s.enableDrag &&
                    ...
                    $(window).on("mouseup.lg", function (t) {
                        n
                            ? ((n = !1), e.touchEnd(s - i), e.$el.trigger("onDragend.lg"))
                            : ($(t.target).hasClass("lg-object") || $(t.target).hasClass("lg-video-play")) &&
                              e.$el.trigger("onSlideClick.lg"),
                ...
                this.$outer.find(".lg-close").on("click.lg", function () {
                    ...
                    e.s.closable &&
                        ...
                        e.$outer.on("mouseup.lg", function (t) {
                            ($(t.target).is(".lg-outer") ||
                                $(t.target).is(".lg-item ") ||
                                ($(t.target).is(".lg-img-wrap") && i)) &&
                                (e.$outer.hasClass("lg-dragging") || e.destroy());
                        }));
            }),
            (e.prototype.destroy = function (t) {
                var e = this;
                t || (e.$el.trigger("onBeforeClose.lg"), $(window).scrollTop(e.prevScrollTop)),
                    t &&
                        (e.s.dynamic || this.$items.off("click.lg click.lgcustom"), $.removeData(e.el, "lightGallery")),
                    this.$el.off(".lg.tm"),
                    $.each($.fn.lightGallery.modules, function (t) {
            ...
            ($.fn.lightGallery = function (t) {
                return this.each(function () {
                    ...
                    else $.data(this, "lightGallery", new e(this, t));
                });
            }),
            ...
            (t.prototype.init = function () {
                ...
                (t.prototype.controls = function () {
                    ...
                    i(this.core.s.appendAutoplayControlsTo).append(
                        '<button aria-label="Toggle autoplay" class="lg-autoplay-button lg-icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg></button>'
                    ),
            ...
            (t.prototype.init = function () {
                ...
                if (this.core.s.fullScreen) {
                    if (
                        ...
                        return;
                    (t = '<button aria-label="Toggle fullscreen" class="lg-fullscreen lg-icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"></path></svg></button>'),
            ...
            (t.prototype.init = function () {
                ...
                s.core.$el.on("onAfterSlide.lg.tm", function (t, e, i) {
                    history.replaceState
                        ...
                        : (window.location.hash = "lg=" + s.core.s.galleryId + "&slide=" + i);
                }),
            ...
            (t.prototype.init = function () {
                ...
                (t.prototype.build = function () {
                            ...
                            ? o.youtube
                                ...
                                : o.vimeo
                                  ? r.core.s.loadVimeoThumbnail
                                      ? ((s = "//i.vimeocdn.com/video/error_" + a + ".jpg"), (n = o.vimeo[1]))
                                      : (s = e)
                                  : o.dailymotion &&
                    ...
                    if (
                        ...
                        r.core.$outer
                            .find(".lg")
                            .append('<div class="lg-thumb-outer"><div class="lg-thumb lg-group"></div></div>'),
                        ...
                        for (var i = 0; i < r.core.s.dynamicEl.length; i++)
                            e(r.core.s.dynamicEl[i].src, r.core.s.dynamicEl[i].thumb, i);
                    else
                        r.core.$items.each(function (t) {
                            r.core.s.exThumbImage
                                ? e(
                                      h(this).attr("href") || h(this).attr("data-src"),
                                      h(this).attr(r.core.s.exThumbImage),
                                      t
                                  )
                                : e(
                                      h(this).attr("href") || h(this).attr("data-src"),
                                      h(this).find("img").attr("src"),
                                      t
                                  );
                        });
                    r.core.$outer.find(".lg-thumb").html(l),
                        (t = r.core.$outer.find(".lg-thumb-item")).each(function () {
                            var e = h(this),
                        ...
                        t.eq(r.core.index).addClass("active"),
                        ...
                        h(window).on("resize.lg.thumb orientationchange.lg.thumb", function () {
                            setTimeout(function () {
                        ...
                        (this.left = (this.core.s.thumbWidth + this.core.s.thumbMargin) * t - 1 - e),
                            ...
                            this.core.lGalleryOn
                                ? (i.hasClass("on") ||
                                  ...
                                  this.core.doCss() || i.animate({ left: -this.left + "px" }, this.core.s.speed))
                ...
                (t.prototype.enableThumbDrag = function () {
                    ...
                    e.$thumbOuter.addClass("lg-grab"),
                        ...
                        h(window).on("mousemove.lg.thumb", function (t) {
                            o &&
                                ((r = e.left),
                                (n = !0),
                                (s = t.pageX),
                        ...
                        h(window).on("mouseup.lg.thumb", function () {
                            n
                                ? ((n = !1),
                ...
                (t.prototype.enableThumbSwipe = function () {
                    ...
                    e.core.$outer.find(".lg-thumb").on("touchstart.lg", function (t) {
                        e.thumbTotalWidth > e.thumbOuterWidth &&
                            (t.preventDefault(), (i = t.originalEvent.targetTouches[0].pageX), (e.thumbClickable = !1));
                    }),
                ...
                (t.prototype.thumbkeyPress = function () {
                    var e = this;
                    h(window).on("keydown.lg.thumb", function (t) {
                        38 === t.keyCode
                            ? (t.preventDefault(), e.core.$outer.addClass("lg-thumb-open"))
                            : 40 === t.keyCode && (t.preventDefault(), e.core.$outer.removeClass("lg-thumb-open"));
                    });
                }),
                (t.prototype.destroy = function () {
                    this.core.s.thumbnail &&
                        1 < this.core.$items.length &&
                        (h(window).off("resize.lg.thumb orientationchange.lg.thumb keydown.lg.thumb"),
                        this.$thumbOuter.remove(),
                        this.core.$outer.removeClass("lg-has-thumb"));
                }),
                (h.fn.lightGallery.modules.Thumbnail = t);
        })();
    }),
    (function (t, e) {
        "function" == typeof define && define.amd
        ...
        !(function () {
            ...
            (t.prototype.init = function () {
                var r = this,
                    t =
                         '<button aria-label="Zoom in" id="lg-zoom-in" class="lg-icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line><line x1="11" y1="8" x2="11" y2="14"></line><line x1="8" y1="11" x2="14" y2="11"></line></svg></button><button aria-label="Zoom out" id="lg-zoom-out" class="lg-icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line><line x1="8" y1="11" x2="14" y2="11"></line></svg></button>';
                r.core.s.actualSize &&
                    (t +=
                        '<button aria-label="Actual size" id="lg-actual-size" class="lg-icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 3 21 3 21 9"></polyline><polyline points="9 21 3 21 3 15"></polyline><line x1="21" y1="3" x2="14" y2="10"></line><line x1="3" y1="21" x2="10" y2="14"></line></svg></button>'),
                    r.core.s.useLeftForZoom
                        ? r.core.$outer.addClass("lg-use-left-for-zoom")
                        : r.core.$outer.addClass("lg-use-transition-for-zoom"),
                    this.core.$outer.find(".lg-toolbar").append(t),
                    r.core.$el.on("onSlideItemLoad.lg.tm.zoom", function (t, e, i) {
                        var s = r.core.s.enableZoomAfter + i;
                ...
                function e(t) {
                    ...
                    e.css("transform", "scale3d(" + t + ", " + t + ", 1)").attr("data-scale", t),
                        r.core.s.useLeftForZoom
                            ? e
                                  .parent()
                                  .css({ left: -o + "px", top: -n + "px" })
                                  .attr("data-x", o)
                                  .attr("data-y", n)
                            : e
                                  .parent()
                                  .css("transform", "translate3d(-" + o + "px, -" + n + "px, 0)")
                                  .attr("data-x", o)
                                  .attr("data-y", n);
                }
                function l() {
                ...
                function s(t, e, i, s) {
                    var o = e.prop("offsetWidth"),
                        n = r.core.s.dynamic
                            ? r.core.s.dynamicEl[i].width || e[0].naturalWidth || o
                            : r.core.$items.eq(i).attr("data-width") || e[0].naturalWidth || o;
                    r.core.$outer.hasClass("lg-zoomed") ? (a = 1) : o < n && (a = n / o || 2),
                        s
                            ? ((r.pageX = u(window).width() / 2),
                              (r.pageY = u(window).height() / 2 + u(window).scrollTop()))
                            : ((r.pageX = t.pageX || t.originalEvent.targetTouches[0].pageX),
                              (r.pageY = t.pageY || t.originalEvent.targetTouches[0].pageY)),
                        l(),
                        setTimeout(function () {
                ...
                r.core.$el.on("onAferAppendSlide.lg.tm.zoom", function (t, e) {
                    ...
                    u("#lg-actual-size").on("click.lg", function (t) {
                        s(t, r.core.$slide.eq(r.core.index).find(".lg-image"), r.core.index, !0);
                    }),
                    r.core.$el.on("onBeforeSlide.lg.tm", function () {
                        (a = 1), r.resetZoom();
                    }),
                ...
                (t.prototype.zoomSwipe = function () {
                    ...
                    o.core.$slide.on("touchstart.lg", function (t) {
                        ...
                        o.core.$outer.hasClass("lg-zoomed") &&
                            ...
                            (h = e.prop("offsetHeight") * e.attr("data-scale") > o.core.$outer.find(".lg").height()),
                            ((a = e.prop("offsetWidth") * e.attr("data-scale") > o.core.$outer.find(".lg").width()) ||
                                h) &&
                                (t.preventDefault(),
                                (n = {
                        ...
                        o.core.$slide.on("touchmove.lg", function (t) {
                            ...
                            o.core.$outer.hasClass("lg-zoomed") &&
                                ...
                                (s = h ? -Math.abs(e.attr("data-y")) + (r.y - n.y) : -Math.abs(e.attr("data-y"))),
                                (i = a ? -Math.abs(e.attr("data-x")) + (r.x - n.x) : -Math.abs(e.attr("data-x"))),
                                (15 < Math.abs(r.x - n.x) || 15 < Math.abs(r.y - n.y)) &&
                                    (o.core.s.useLeftForZoom
                                        ? e.css({ left: i + "px", top: s + "px" })
                                        : e.css("transform", "translate3d(" + i + "px, " + s + "px, 0)")));
                        }),
                        o.core.$slide.on("touchend.lg", function () {
                            o.core.$outer.hasClass("lg-zoomed") &&
                                l &&
                                ((l = !1), o.core.$outer.removeClass("lg-zoom-dragging"), o.touchendZoom(n, r, a, h));
                        });
                }),
                (t.prototype.zoomDrag = function () {
                    ...
                    o.core.$slide.on("mousedown.lg.zoom", function (t) {
                        ...
                        (d = e.prop("offsetHeight") * e.attr("data-scale") > o.core.$outer.find(".lg").height()),
                            (h = e.prop("offsetWidth") * e.attr("data-scale") > o.core.$outer.find(".lg").width()),
                            o.core.$outer.hasClass("lg-zoomed") &&
                        ...
                        u(window).on("mousemove.lg.zoom", function (t) {
                            ...
                            l &&
                                ...
                                o.core.$outer.addClass("lg-zoom-dragging"),
                                (s = d ? -Math.abs(e.attr("data-y")) + (r.y - n.y) : -Math.abs(e.attr("data-y"))),
                                (i = h ? -Math.abs(e.attr("data-x")) + (r.x - n.x) : -Math.abs(e.attr("data-x"))),
                                o.core.s.useLeftForZoom
                                    ? e.css({ left: i + "px", top: s + "px" })
                                    : e.css("transform", "translate3d(" + i + "px, " + s + "px, 0)"));
                        }),
                        u(window).on("mouseup.lg.zoom", function (t) {
                            l &&
                                ...
                                !a ||
                                    (n.x === r.x && n.y === r.y) ||
                                    ((r = { x: t.pageX, y: t.pageY }), o.touchendZoom(n, r, h, d)),
                                (a = !1)),
                ...
                (t.prototype.touchendZoom = function (t, e, i, s) {
                    var o = this,
                        ...
                        l = -Math.abs(n.attr("data-x")) + (e.x - t.x),
